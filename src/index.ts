...
if (consulta2Atualizada) consultas.push(consulta2Atualizada);
if (consulta3Atualizada) consultas.push(consulta3Atualizada);

consultas.push(consulta4Atualizada);

if (consulta5Atualizada) consultas.push(consulta5Atualizada);
